...
@XmlRootElement(name = "ObtenerIndicadoresEconomicosXMLResponse", namespace = "http://ws.sdde.bccr.fi.cr")
public class ObtenerIndicadoresEconomicosXMLResponse {

    @XmlElement(name = "ObtenerIndicadoresEconomicosXMLResult", namespace = "http://ws.sdde.bccr.fi.cr")
