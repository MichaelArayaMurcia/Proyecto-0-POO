...
@XmlRootElement(name = "ObtenerIndicadoresEconomicosXML", namespace = "http://ws.sdde.bccr.fi.cr")
public class ObtenerIndicadoresEconomicosXML {

    @XmlElement(name = "Indicador", namespace = "http://ws.sdde.bccr.fi.cr")
    protected String indicador;
    @XmlElement(name = "FechaInicio", namespace = "http://ws.sdde.bccr.fi.cr")
    protected String fechaInicio;
    @XmlElement(name = "FechaFinal", namespace = "http://ws.sdde.bccr.fi.cr")
    protected String fechaFinal;
    @XmlElement(name = "Nombre", namespace = "http://ws.sdde.bccr.fi.cr")
    protected String nombre;
    @XmlElement(name = "SubNiveles", namespace = "http://ws.sdde.bccr.fi.cr")
    protected String subNiveles;
    @XmlElement(name = "CorreoElectronico", namespace = "http://ws.sdde.bccr.fi.cr")
    protected String correoElectronico;
    @XmlElement(name = "Token", namespace = "http://ws.sdde.bccr.fi.cr")
