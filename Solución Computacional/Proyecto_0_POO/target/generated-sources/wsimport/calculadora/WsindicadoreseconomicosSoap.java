...
public interface WsindicadoreseconomicosSoap {
     ...
     * @param token
     * @return
     *     returns calculadora.ObtenerIndicadoresEconomicosResponse.ObtenerIndicadoresEconomicosResult
     */
    ...
    @RequestWrapper(localName = "ObtenerIndicadoresEconomicos", targetNamespace = "http://ws.sdde.bccr.fi.cr", className = "calculadora.ObtenerIndicadoresEconomicos")
    @ResponseWrapper(localName = "ObtenerIndicadoresEconomicosResponse", targetNamespace = "http://ws.sdde.bccr.fi.cr", className = "calculadora.ObtenerIndicadoresEconomicosResponse")
    public calculadora.ObtenerIndicadoresEconomicosResponse.ObtenerIndicadoresEconomicosResult obtenerIndicadoresEconomicos(
    ...
    @RequestWrapper(localName = "ObtenerIndicadoresEconomicosXML", targetNamespace = "http://ws.sdde.bccr.fi.cr", className = "calculadora.ObtenerIndicadoresEconomicosXML")
    @ResponseWrapper(localName = "ObtenerIndicadoresEconomicosXMLResponse", targetNamespace = "http://ws.sdde.bccr.fi.cr", className = "calculadora.ObtenerIndicadoresEconomicosXMLResponse")
